...
function Fotter() {
    return (
        <div className=' font-inter p-10 bg-white '>
            <div className=' max-w-screen flex md:justify-around flex-wrap gap-3.5  '>

                <div className='h-full flex flex-col justify-center'>
                    <Logo className=" size-50 md:size-25 lg:size-50 " />
                </div>
                <div className=' text-base flex flex-col gap-2.5' >
                    <p className=' text-xl lg:text-2xl py-2.5'>Quick links</p>
                    <p>Home</p>
                    <p>Products</p>
                    <p>About</p>
                    <p>FAQ</p>
                ...
                <div className='flex flex-col gap-2.5'>
                    <p className=' text-xl lg:text-2xl py-2.5'>REACH US AT :</p>
                ...
                <div className='flex flex-col gap-2.5 py-2.5'>
                    <p className=' text-xl lg:text-2xl'>Follow Us On :-</p>
